      ...
      <div className='flex-1 px-6 py-20'>
        ...
        <div className='text-center mb-28'>
          ...
          <motion.p
            ...
            Role-based mock interviews with smart follow-ups, adaptive difficulty and real-time perfomance evaluation.
          </motion.p>
        ...
        <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
          {
            [
              ...
              <motion.div key={index}
               ...
               ${index === 0 ? "rotate-[-4deg]" : ""}
               ${index === 1 ? "rotate-[3deg] md:-mt-6 shadow-x1" : ""} 
               ${index === 2 ? "rotate-[-3deg]" : ""}
               `}>
          ...
          <div className='grid md:grid-cols-2 gap-10'>
            {
              [
                ...
                },
                {
                  ...
                  desc: "Project-Specific questionsbased on uploaded resume."
                },
                {
                  image: pdfImg,
                  icon: <BsFileEarmarkText size={20} />,
                ...
                },
                {
                  ...
                  desc: "Track progress with perfomance graphs and topic analysis."
                }
              ].map((item, index) => (
                <motion.div key={index}
                  initial={{ opacity: 0, y: 30 }}
              ...
              [
                {
                  ...
                  desc: "Behavioral and commiunication based evaluation."
                },
                {
                  image: techImg,
                ...
                },
                {
                  ...
                  desc: "Basic tone and voice analysi insights."
                },
                {
                  image: confidenceImg,
