...
function Step3Report({ report }) {
  ...
  const downloadPDF = () => {
    ...
    doc.text("AI Interview Perfomance Report ", pageWidth / 2, currentY, { align: "center" });
    ...
    if (finalScore >= 8) {
      ...
      advice="Good function shown. Improve clarity and structure .Practice delevering concise,confident answer with stronger supporting examples.";
    }else{
    ...
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8'>
        <div className='space-y-6'>
          ...
          <div className='mt-4'>
            <p className='font-semibold text-gray-800 text-sm sm:text-base'>{perfomanceText}</p>
        ...
        <div className='lg:col-span-2 space-y-6'>
          ...
          className='bg-white rounded-2xl sm:rounded-3xl shadow-lg p-5 sm:p-8'>
            <h3 className='text-base sm:text-lg font-semibold text-gray-700 mb-4 sm:mb-6'>Perfomance Trend</h3>
