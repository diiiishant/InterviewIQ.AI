        ...
        <motion.div
            ...
            <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
                <motion.div
                    ...
                    className='relative bg-gradient-to-br from-green-100 to-green-100 p-12 flex flex-col justify-center'>
                                ...
                                {skills.length > 0 && (
                                    <div>
                                        ...
                                        <div className='flex  flex-wrap gap-2'>
                                            {skills.map((s, i) => (
                                                <span key={i} className='bg-green-100  text-green-700 py-1 px-3 rounded-full text-sm'>
                                                    {s}
                                                </span>
                                            ))}
                                        </div>
